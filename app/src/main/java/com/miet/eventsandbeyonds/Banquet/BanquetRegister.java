...
public class BanquetRegister extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banquet_register);
        ...
        mEmailView = (EditText)findViewById(R.id.emailBanquet);
        mPasswordView = (EditText)findViewById(R.id.passwordBanquet);
        mHallName = (EditText)findViewById(R.id.nameBanquet);
        mOpeningHours = (EditText)findViewById(R.id.openingHrsBanquet);
        mPhone = (EditText)findViewById(R.id.phoneBanquet);
        mAddress = (EditText)findViewById(R.id.addressBanquet);
        mPrice = (EditText)findViewById(R.id.priceBanquet);

        registerBtn = (Button)findViewById(R.id.registerBtnBanquet);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.registerBtnBanquet:
                getEditTextValues();
                progressDialog = new ProgressDialog(BanquetRegister.this,
    ...
    public class UserRegisterTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(BanquetRegister.this, "Try Again", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected void onCancelled() {
            ...
            Toast.makeText(BanquetRegister.this, "Registration Canceled", Toast.LENGTH_SHORT).show();
        }
    }
}
