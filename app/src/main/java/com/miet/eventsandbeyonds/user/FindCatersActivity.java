...
public class FindCatersActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private HashMap<String, String> nameIdHashMap = new HashMap<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_find_caters);

        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.find_cater_map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                Intent intent = new Intent(FindCatersActivity.this,FeedbackActivity.class);
    ...
    private class GetData extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(FindCatersActivity.this, "Downloading Data", "Please wait...", true, true);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                {
                    Toast.makeText(FindCatersActivity.this, "No Caters Found", Toast.LENGTH_SHORT).show();
                    loading.dismiss();
                    return;
                }
        ...
        protected void onCancelled() {
            super.onCancelled();
            loading.dismiss();
            Toast.makeText(FindCatersActivity.this, "Canceled", Toast.LENGTH_LONG).show();
        }
    }
}
